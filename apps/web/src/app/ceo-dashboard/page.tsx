...
export default function CEODashboardPage() {
  ...
  const stats = useMemo(() => {
    ...
    const urgent = filteredOrders.filter((o) => o.isUrgent || o.priority === OrderPriority.URGENT).length;
    ...
    // إحصائيات مالية
    const financial = {
      totalEstimated: filteredOrders.reduce((sum, o) => sum + (o.estimatedCost || 0), 0),
      totalFinal: filteredOrders.reduce((sum, o) => sum + (o.finalCost || 0), 0),
  ...
  const urgentOrders = useMemo(() => {
    return orders.filter((o) => 
      (o.isUrgent || o.priority === OrderPriority.URGENT) && 
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <FinancialMetric
              ...
              value={stats.financial.totalEstimated}
              color="text-gray-700"
            />
            <FinancialMetric
              label="التكلفة النهائية"
              value={stats.financial.totalFinal}
              color="text-blue-700"
            />
            <FinancialMetric
              label="المبلغ المدفوع"
              value={stats.financial.totalPaid}
